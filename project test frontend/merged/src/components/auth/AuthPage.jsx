          ...
          <div className="relative z-10 bg-white/6 border border-white/10 rounded-2xl p-4 animate-fade-up" style={{animationDelay:'0.7s'}}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-1 pl-8">
                {[0,1,2].map(i => <span key={i} className="w-1.5 h-1.5 rounded-full bg-white/25 animate-pulse" style={{animationDelay:`${i*0.2}s`}}/>)}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="w-full">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl
                         ...
                         transition-all duration-150 active:scale-[0.98] mb-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" className="btn-primary w-full" disabled={loading}>
                {loading
                  ? <><svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" strokeOpacity="0.3"/><path d="M12 2a10 10 0 0110 10"/></svg>Түр хүлээнэ үү…</>
